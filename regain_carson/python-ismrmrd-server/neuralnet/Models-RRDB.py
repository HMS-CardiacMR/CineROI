...
image_In = 48  #"Image size of high resolution image."
scale_factor = 1
...
class GeneratorRRDB(nn.Module):
    def __init__(self, channels, filters=64, num_res_blocks=23, num_upsample=2):
        ...
        self.upsample1= nn.Conv2d(filters,filters,kernel_size=3,stride=1,padding=1)
        self.upsample2= nn.Conv2d(filters,filters,kernel_size=3,stride=1,padding=1)
