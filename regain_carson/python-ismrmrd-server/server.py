...
class Server:
    ...
    def handle(self, sock):
        ...
        try:
            ...
            elif (config == "regain_segmentation"):
                logging.info("Starting regain segmentation processing based on config")
                regain_segmentation.process(connection, config, metadata)
            elif (config == "null"):
