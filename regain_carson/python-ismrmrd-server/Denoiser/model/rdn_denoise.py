...
class RDN_denoise_eval(nn.Module):
    def __init__(self):
        super(RDN_denoise_eval, self).__init__()
        n_channels=1
        G0 = 32
        k_size = 3
        SFENet_ksize = 3
        ...
        # Shallow feature extraction net
        self.SFENet1 = nn.Conv2d(n_channels, G0, SFENet_ksize, padding=(SFENet_ksize-1)//2, stride=1)
        self.SFENet2 = nn.Conv2d(G0, G0, SFENet_ksize, padding=(SFENet_ksize-1)//2, stride=1)
        ...
        # Last conv layer
        self.last_conv = nn.Conv2d(G, n_channels, last_conv_ksize,
                                   padding=(last_conv_ksize-1)//2, stride=1)
